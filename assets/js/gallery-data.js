...
(function () {
  ...
  VM.galleryImages = [
    {
      id: 'mens-circle-2026-main',
      src: 'assets/images/Vince/web/events/mens-circle-2026/mens-circle-main.jpg',
      alt: 'The Men\'s Circle event lineup artwork featuring Vicent Manila, Ram Hadji and Elizabeth Feria',
      category: 'speaking',
      title: 'The Men\'s Circle — Event Lineup',
      caption: 'AIESEC Alumni Tanzania event artwork for the 17 September 2026 virtual conversation on men, purpose and leadership.',
      width: 1080,
      height: 1350,
      featured: true,
    },
    {
      ...
      caption: 'Host artwork featuring Vicent Manila for The Men\'s Circle.',
      width: 1080,
      height: 1350,
      featured: true,
    },
    {
      id: 'mens-circle-2026-ram',
      src: 'assets/images/Vince/web/events/mens-circle-2026/mens-circle-ram-hadji.jpg',
      alt: 'The Men\'s Circle guest artwork featuring Ram Hadji',
      category: 'speaking',
      title: 'The Men\'s Circle — Ram Hadji',
      caption: 'Guest artwork from The Men\'s Circle event campaign.',
      width: 1080,
      height: 1350,
      featured: false,
    },
    {
      id: 'mens-circle-2026-elizabeth',
      src: 'assets/images/Vince/web/events/mens-circle-2026/mens-circle-elizabeth-feria.jpg',
      alt: 'The Men\'s Circle guest artwork featuring Elizabeth Feria',
      category: 'speaking',
      title: 'The Men\'s Circle — Elizabeth Feria',
      caption: 'Guest artwork from The Men\'s Circle event campaign.',
      width: 1080,
      height: 1350,
      featured: false,
    ...
    {
      id: 'mens-circle-2026-cover',
      src: 'assets/images/Vince/web/events/mens-circle-2026/mens-circle-cover.jpg',
      alt: 'The Men\'s Circle event cover artwork',
      category: 'speaking',
      title: 'The Men\'s Circle — Event Cover',
      caption: 'Campaign cover for The Men\'s Circle, a virtual conversation on men, purpose and leadership.',
      width: 1080,
      height: 1350,
      featured: false,
    },
